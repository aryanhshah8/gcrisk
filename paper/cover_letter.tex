...
assessment: organ-specific REID, SEP acute hazard, and global uncertainty
quantification''} for publication in \textit{Life Sciences in
Space Research}.
...
scaling factors) together account for approximately 88\% of REID output
variance, while GCR physics parameters contribute approximately 12\%,
