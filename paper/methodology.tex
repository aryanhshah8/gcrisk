...
check. Full derivations are given in Supplementary Methods
(\S{}S1.1--S1.9); only the physics needed to interpret the Results is
summarized here.
...
HZE fraction ($13.0\%$ at $16\gcm$ Al) is $\sim\!1.7\times$ the NASA Space
Radiation Laboratory (NSRL) reference field \citep{slaba2016}, versus
$\sim\!4\times$ under the prior
...
\textbf{Organ dose and quality factor.} Absorbed dose and International
Commission on Radiological Protection (ICRP)-60 dose
